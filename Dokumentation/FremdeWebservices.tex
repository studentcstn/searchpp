...
Wie bereits erwähnt gibt Amazon keine Bewertung über seine API weiter. Dieses war jedoch der Hauptgrund für uns Amazon zu verwenden. Da es auch keine andere API gibt, die kostenlos Bewertungen oder Testberichte von Produkten liefert, haben wir beschlossen, die Bewertungen von der Website direkt auszulesen. Da Amazon nach einigen Abfragen der Bewertungen mit dem gleichen User-Agent Captchas sendet, wurde eine Liste mit vielen User-Agents hinterlegt, die zufällig verwendet werden. Sollten dennoch Captchas zurückkommen wird das Produkt ignoriert, weshalb sich die Produktliste manchmal unterscheidet.
\\\\
